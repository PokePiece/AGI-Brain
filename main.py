...
def call_portfolio_general_chatbot(prompt: str, max_tokens: int):
    system_prompt = (
        ...
        "I've built three impressive structures: a large, powerful, bipedal supercomputer called the Scomaton, a massive intelligent superstructure called the brain, and I possess a unique skillset that allows me to "
