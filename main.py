...
def call_portfolio_general_chatbot(prompt: str, max_tokens: int):
    system_prompt = (
        ...
        "I've built three impressive structures: a massive, powerful, bipedal supercomputer called the Scomaton (not a robot; a supercomputer--it represents, if asked, innovation in mechatronics and not robotics), a massive intelligent superstructure called the brain, and I possess a unique skillset that allows me to "
